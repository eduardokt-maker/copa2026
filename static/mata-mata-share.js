...
const KNOCKOUT_SHARE_IMAGE_URL = "/mata-mata-share-card.png?v=20260629-share-v2";
...
async function shareKnockoutImageFile() {
...
async function shareKnockoutStory() {
  if (navigator.share) {
    try {
      if (await shareKnockoutImageFile()) return;
    } catch (error) {
