...
APP_NAME = "copa2026"
APP_VERSION = "2026.06.29-knockout-share-v10"
...
def render_knockout_share_html(match: dict) -> bytes:
    ...
    image_url = f"{base_url}/mata-mata-share-card.png?v=20260629-share-v3"
...
<html lang="pt-BR">
  ...
  <body class="share-card-page">
    <main class="share-card-shell" aria-label="Compartilhamento do mata-mata">
      <img src="/mata-mata-share-card.png?v=20260629-share-v3" alt="Arte Copa 2026" />
